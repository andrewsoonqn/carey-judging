...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run OpenAI-backed conversation pipeline.")
    parser.add_argument(
        "--resume",
        type=Path,
        metavar="RUN_DIR",
        help="Resume a run (path under runs/, e.g. runs/run_demo_openai_20260101_120000_000000)",
    )
    parser.add_argument(
        "--start",
        type=int,
